...
@section('asaasCobrancas.content')
        ...
        <div class="card">
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                <ol class="breadcrumb m-0 p-0">
                    ...
                    <li class="breadcrumb-item">@lang('Edit Asaas Cobranca') #{{$asaasCobranca->id}}</li>
                </ol>
            </div>
            <div class="card-body">
                <form action="{{ route('asaas_cobrancas.update', compact('asaasCobranca')) }}" method="POST" class="m-0 p-0">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
    ...
    <select name="asaas_client_id" id="asaas_client_id" class="form-control form-select flex-grow-1" required>
        ...
        @foreach($asaasClients as $asaasClient)
            <option value="{{ $asaasClient->id }}" {{ @old('asaas_client_id', $asaasCobranca->asaas_client_id) == $asaasClient->id ? "selected" : "" }}>{{ $asaasClient->name }}</option>
        @endforeach
    </select>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="customer" id="customer" class="form-control" value="{{@old('customer', $asaasCobranca->customer)}}" required/>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="billingType" id="billingType" class="form-control" value="{{@old('billingType', $asaasCobranca->billingType)}}" required/>
    ...
    <div class="mb-3">
        ...
        <input type="number" name="value" id="value" class="form-control" value="{{@old('value', $asaasCobranca->value)}}" required/>
        @if($errors->has('value'))
    ...
    <div class="mb-3">
        ...
        <input type="date" name="dueDate" id="dueDate" class="form-control" value="{{@old('dueDate', $asaasCobranca->dueDate)}}" required/>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="paymentLink" id="paymentLink" class="form-control" value="{{@old('paymentLink', $asaasCobranca->paymentLink)}}" />
    ...
    <div class="mb-3">
        ...
        <input type="text" name="status" id="status" class="form-control" value="{{@old('status', $asaasCobranca->status)}}" required/>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="invoiceUrl" id="invoiceUrl" class="form-control" value="{{@old('invoiceUrl', $asaasCobranca->invoiceUrl)}}" required/>
    ...
    <div class="mb-3">
        ...
        <input type="date" name="paymentDate" id="paymentDate" class="form-control" value="{{@old('paymentDate', $asaasCobranca->paymentDate)}}" />
    ...
    <div class="mb-3">
        ...
        <input type="number" name="service_id" id="service_id" class="form-control" value="{{@old('service_id', $asaasCobranca->service_id)}}" required/>
		...
		@endif
                    ...
                    <div class="card-footer">
                        <div class="d-flex flex-row align-items-center justify-content-between">
                            <a href="{{ route('asaas_cobrancas.index', []) }}" class="btn btn-light">Cancel</a>
                            <button type="submit" class="btn btn-primary">@lang('Update Asaas Cobranca')</button>
                        </div>
                    </div>
                </form>
            </div>
