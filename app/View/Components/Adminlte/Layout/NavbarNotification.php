...
class NavbarNotification extends Component
{
    ...
    /**
     * ServiceCreateChargesAsaasClient a new component instance.
     *
     * @return void
     */
    ...
    /**
     * ServiceCreateChargesAsaasClient the url used for fetch new notification data.
     *
     * @return string|null
     */
    ...
    /**
     * ServiceCreateChargesAsaasClient the url from specific configuration type.
     *
